...
#[derive(Debug)]
pub struct TideOrbitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TideOrbitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TideOrbit processing");
    
    let mut processor = TideOrbitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TideOrbitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TideOrbitProcessor::new(false);
